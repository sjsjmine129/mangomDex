...
class StickerDetailCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            imgVwSticker.centerXAnchor.constraint(equalTo: vwContainer.centerXAnchor),
            imgVwSticker.widthAnchor.constraint(equalToConstant: 280),
            imgVwSticker.heightAnchor.constraint(equalToConstant: 280),
            //stButtons
            ...
            //lblId
            lblId.topAnchor.constraint(equalTo: vwid.topAnchor),
            lblId.bottomAnchor.constraint(equalTo: vwid.bottomAnchor),
            lblId.leadingAnchor.constraint(equalTo: vwid.leadingAnchor, constant: 8),
            lblId.trailingAnchor.constraint(equalTo: vwid.trailingAnchor, constant: -8),
            //vwLinkBox
