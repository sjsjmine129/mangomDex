...
class ProductViewModel{
    ...
    private(set) var products: [Product] = [
        Product(name: "망곰이의딸기샌드", price: 3600, findLink: "https://pocketcu.co.kr/search/stock?isRecommend=Y&item_cd=8809895798564", productLink: "https://pocketcu.co.kr/product/detail/2023120035518?cateTyp="),
        ...
        Product(name: "망곰바질토마토베이글", price: 4900)
